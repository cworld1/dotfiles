...
get_icon() {
	...
	if [[ "$current" -eq "0" ]]; then
		echo "$iDIR/notification-audio-volume-muted.svg"
	elif [[ ("$current" -ge "0") && ("$current" -le "30") ]]; then
		echo "$iDIR/notification-audio-volume-low.svg"
	elif [[ ("$current" -ge "30") && ("$current" -le "60") ]]; then
		echo "$iDIR/notification-audio-volume-medium.svg"
	elif [[ ("$current" -ge "60") && ("$current" -le "100") ]]; then
		echo "$iDIR/notification-audio-volume-high.svg"
	fi
}
